#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "76ce396fd9361353eee9d5645fdacf4b49af1865"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"76ce396fd9361353eee9d5645fdacf4b49af1865", @"/Views/Requests/Create.cshtml")]
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "76ce396fd9361353eee9d5645fdacf4b49af18655608", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "76ce396fd9361353eee9d5645fdacf4b49af18656006", async() => {
...
<script>
    ...
    function generate_path() {
        ...
        if (!tree) {
            for (let i = 0; i < ids.length; i++) {
                ...
                if (i < ids.length - 1) {
                    elem +=");
            WriteLiteral(@" '<div style=""display:inline-block"" class=""path"">'+
            ...
            for (let i = 0; i < ids.length - 1; i++) {
                ...
                for (let j = 0; j < ids.length;j++) {
                    ...
                    var name = $('#activity-name' + ai.toString()).val();
          ");
            WriteLiteral(@"          elem += '<option value=""' + name + '"">' + name + '</option>';
                }
    ...
    function add_path(i) {
        ...
        elem += '</select><div style=""display: inline-block"" class=""path"">' + 
      ");
            WriteLiteral(@"          '<p style=""display:inline-block"">--</p>' +
                '</div>';
        elem += '<input id=""node-action' + (i + 1).toString() + '"" class=""form-control"" placeholder=""action"" style=""display:inline-block; width: auto"" />';
        if (i < ids.length - 1) {
            elem += '<div style=""display: inline-block"" class=""path"">' + 
    ...
    function default_condition(params) {
        var new_elem = '<label style=""dis");
            WriteLiteral(@"play: inline-block"" class=""control-label"">Điều kiện mặc định: </label>'
            + '<ul class=""list-group"">';
        ...
        switch (type) {
            case 'CAMPAIGN':
                state_view += '<div class=""campaign-contents"">' +
                        ...
                        '<div hidden st");
            WriteLiteral(@"yle=""display:block""><label class=""control-label"">Tên chiến dịch</label>' +
            ...
            case 'CONTACT':
                stat");
            WriteLiteral(@"e_view += '<div class=""contact-contents"">' +
                        ...
                        '<input class=""form-control"" placeholder=""SĐT"" type=""nu");
            WriteLiteral(@"mber"" id=""activity-numb' + id + '"">' + 
                        ...
                        '<div class=""role-area""><span hidden>Đối tượng thực hiện (chọn 1 hoặc nhiều): </span>' +
                                    '<select hidden class=""form-control"" id=""role-type' + id + '"" multiple>' +
                                        ...
                                        '<option selected value=""crm"">Bộ phận nghiệp vụ</option>' +
                                        '<op");
            WriteLiteral(@"tion value=""other"">Khác</option>' +
                                    '</select>' +
                            '</div>' +
                        '<hr/></div>';
                break;
            ...
            case 'ABSENT':
                if ($('#manual-proceed').is(':checked')) {
                    state_view += '<div class=""absent-contents"">' +
                            ...
                            '<span hidden>Thời gian thực hiện công việc (giờ): </span> <input type=""number"" class=""");
            WriteLiteral(@"form-control"" id=""activity-dura' + id + '"" hidden value=""1"">' +
            ...
            WriteLiteral(@">' +
             ...
             ");
            WriteLiteral(@"           '<i class=""fas fa-paperclip "" title=""Đính kèm""></i>' +
            ...
            case 'GENERIC':
                state_view += '<div class=""generic-contents"">' +
                        ...
                        '<div><a id=""detail-label"" onclick=""toggling(this)"" class=""control-label"">Mô tả chi tiết</a>' +
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">T");
            WriteLiteral(@"hời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
    ...
    $('.state-icon>i').on('click', function () {
        ...
        $('#activity-");
            WriteLiteral(@"dura' + (curId + 1).toString()).slideToggle();
        ids.push(curId + 1);
        curId++;
    }); 
    ...
    $('#btn-submit').on('click', function (params) {
        ...
        for (let i = 1; i <= ids.length; i++) {
           ...
           ");
            ...
            WriteLiteral(@"ivity);
                ...
                <!-- activity['isreallynotapproved'] = $('#activity-reason' + i.toString()).val(); -->
                <!-- activity['approvername'] = $('#activity-worker' + i.toString()).val(); -->
                activity['reason'] = $('#activity-r");
            WriteLiteral(@"eason' + i.toString()).val();
                roles.forEach(element => {
                    if(!activity['roles'].some(e => e.name === element)) {
                        activity['roles'].push({'name': element});
                    }
        ...
        if (!manual && !tree) {
            ...
            for (let index = 0; index < states.length - 1; index++) {
                var rule = {'action': 'auto advance', 'currentstate': st");
            WriteLiteral(@"ates[index], 'nextstate': states[index + 1]};
      ...
      ");
            WriteLiteral(@"                  const rule = request['process']['rules'][index];
        ...
        if (tree) {
            ...
            rules.paths.forEach(path => {
                ...
                var c = request['process']['nodes'][request['process']['nodes'].findInd");
            WriteLiteral(@"ex(i => i.name === path.nextnode)];
                p.childs.push(c);
        ...
        if (tree) {
            request['c");
            WriteLiteral(@"urrentnode'] = root.name;
        }
        else {
        ...
        if (tree) {
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(34603, 36, false);
#line 698 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(34639, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(35183, 32, false);
#line 716 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(35215, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
