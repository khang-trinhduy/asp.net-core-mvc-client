#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7fbf42ea7ccd9d02a732fc05363d73a58321c925"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7fbf42ea7ccd9d02a732fc05363d73a58321c925", @"/Views/Requests/Create.cshtml")]
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7fbf42ea7ccd9d02a732fc05363d73a58321c9255608", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7fbf42ea7ccd9d02a732fc05363d73a58321c9256006", async() => {
...
<div class=""transition-page"">
    ...
    <i>Nếu không thêm điề");
            WriteLiteral(@"u kiện, hệ thống sẽ tự động chuyển sang công việc tiếp theo dựa vào thứ tự đã được sắp xếp bên trên</i>
...
<script>
    ...
    function generate_path() {
        ...
        if (!tree) {
            ...
            for (let i = 0; i < ids.length - 1; i++) {
                ...
                elem += '</select><div style=""display: inline-bl");
            WriteLiteral(@"ock"" class=""path"">' + 
                        '<p style=""display:inline-block"">--</p>' +
                        '</div>';
                ...
                elem += '</select></div>';                
    ");
            WriteLiteral(@"            if (!activities.includes(activity.name)) {
                    activities.push(activity.name);
                }
            }
            cc = ids.length - 1;
    ...
    function add_path(i) {
        ...
        elem += '</select><div style=""display: inline-block"" class=""path"">' + 
                '<p style=""display:inline-block"">--</p>' +
                '</div>';
        elem += '<input id=""node-action' + (i + 1).toString() + '"" class=""f");
            WriteLiteral(@"orm-control"" placeholder=""action"" style=""display:inline-block; width: auto"" />';
        if (i < ids.length - 1) {
            elem += '<div style=""display: inline-block"" class=""path"">' + 
                '<p style=""display:inline-block"">--></p>' +
                '</div>';
    ...
    functi");
            WriteLiteral(@"on createstate(id, type) {  
        ...
        switch (type) {
            case 'CONTACT':
                state_view += '<div class=""contact-contents"">' +
                        '<input type=""text"" class=""form-control"" placeholder=""Tên công việc"" id=""activity-name' + id + '"" value="""">' +
                        '<a hidden class=""control-label"">Mô tả chi tiết</a>' +
                ...
                ");
            WriteLiteral(@"        '<input class=""form-control"" placeholder=""SĐT"" id=""activity-numb' + id + '"">' + 
            ...
            WriteLiteral(@"việc"" id=""activity-desc' + id + '"">' +
                            '<span hidden>Thời gian thực hiện công việc (giờ): </span> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"" hidden value=""1"">' +
            ...
            WriteLiteral(@"placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
    ...
    function add_transition(i) {
        ...
        activities.forEach(activity => {
            elem += '<option value=""' + activity + '"">' + activi");
            WriteLiteral(@"ty +'</option>';
        });
        elem += '</select>' +
    ...
    function addActivity(id, type) {
        ...
        console.log(type);
   ");
            WriteLiteral(@"     var new_id = id * 10 + ids[id-1];
        ids[id-1]++;
    ...
    function add_activity(type) {
        ...
        switch (type) {
            ...
            case 'ABSENT':
                if ($('#manual-proceed').is(':checked')) {
                    activity_view = '<div class=""absent-contents"">' +
                            ...
                            '<span hidden>Thời gian thực hiện công việc (giờ): </span> <inp");
            WriteLiteral(@"ut type=""number"" class=""form-control"" id=""activity-dura' + id + '"" hidden value=""1"">' +
                            '<input type=""text"" class=""form-control"" placeholder=""Tên nhân viên"" id=""activity-worker' + id + '"" value=""Nguyễn Văn A"">' +
            ...
            WriteLiteral(@"                  '<option selected value=""crm"">Bộ phận nghiệp vụ</option>' +
                ...
                break;
            case 'EMAIL':
                activity_view = '<div class=""email-container"">' + 
                    '<div class=""email-header"">' +
                        '<label class=""control-label"" id=""to"">To: </label>  <input class=""form-control"" id=""to"" type=""text"" placeholder="""" />' +
                        '<a class=""cbb"">Cbb/Bb</a>' +
                        '<div id=""additional""><label class=""control-label"" class=""to"">Cbb: </label>  <input class=""form-control"" id=""Cbb"" type=""text""");
            ...
            case 'GENERIC':
                activity_view = '<div class=""generic-contents"">' +
                        ...
                        '</div>' +
                        '<div class=""role-area"">' +
                                '<select class=""form-control"" id=""role-t");
            WriteLiteral(@"ype' + id + '"" multiple>' +
                                    '<option value=""hr"">Bộ phận nhân sự</option>' +
                                    '<option value=""cm"">Bộ phận nghiệp vụ</option>' +
                                    '<option value=""other"">Khác</option>' +
                                '</select>' +
 ...
 ");
        ...
        for (let i = 1; i <= ids.length; i++) {
            ...
            if (tree) {
                ...
                activity['dayoff");
            WriteLiteral(@"'] = $('#activity-off-day' + i.toString()).val();
                ...
                state = {};
                state['name'] = activi");
            WriteLiteral(@"ty['name'] = $('#activity-name' + i.toString()).val();
                ...
                roles.forEach(element => {
                    if(!activity['roles'].some(e => e.name === element)) {
                        activity['r");
            WriteLiteral(@"oles'].push({'name': element});
                    }
                });
                if (activity.roles.length <= 0) {
                    alert('Chưa chọn đối tượng phụ trách công việc ' + activity.name);
            ...
            if (cdt > 1) {
                for (let i = 1; i < cdt; i++) {
                    ...
                    for (let index = 0; index < request['process']['rules'].length; index++) {
                        ...
                        if (rule.action == another_rule.action || rule.currentstate == another_rule.currentstate || ru");
            WriteLiteral(@"le.nextstate == another_rule.nextstate) {
     ...
     ");
            WriteLiteral(@"       request['process']['nodes'].forEach(node => {
...
");
            WriteLiteral("        }\r\n        <!-- console.log(request); -->\r\n        if (tree) {\r\n            $.ajax({\r\n                type: \"post\",\r\n                url: \'");
            EndContext();
            BeginContext(37489, 36, false);
#line 760 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(37525, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(38069, 32, false);
#line 778 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(38101, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
