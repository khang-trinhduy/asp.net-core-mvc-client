#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "61b4463ae6a982de5242eb4f84334a22aae82be2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"61b4463ae6a982de5242eb4f84334a22aae82be2", @"/Views/Requests/Create.cshtml")]
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "61b4463ae6a982de5242eb4f84334a22aae82be25608", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "61b4463ae6a982de5242eb4f84334a22aae82be26006", async() => {
...
<script>
    ...
    fun");
            WriteLiteral(@"ction add_select(name, id, options) { /*TODO add function to append new select*/
    ...
    function generate_path() {
        ...
        if (!tree) {
            for (let i = 0; i < ids.length; i++) {
                ...
                for");
            WriteLiteral(@" (let j = 0; j < ids.length; j++) {
                    const ai = ids[j];
    ...
    function add_path(i) {
        i = cc;
        var elem = '<div><select style=""display: inline-block"" cla");
            WriteLiteral(@"ss=""form-control"" id=""current-node' + (i + 1).toString() + '"">';
        for (let j = 0; j < ids.length;j++) {
            const ai = ids[j];
            var name = $('#activity-name' + ai.toString()).val();
            elem += '<option value=""' + name + '"">' + name + '</option>';
    ...
    funct");
            WriteLiteral(@"ion change(item, params) {
        for (let i = 0; i < ids.length; i++) {
            const cur = ids[i];
            if(cur != params) {
    ...
    function createstate(id, type) {  
        var state_view = '<div class=""state-header"">' +
            ...
            '<select hidden class");
            WriteLiteral(@"=""form-control"" id=""state-type' + id + '"">' +
        ...
        switch (type) {
            case 'CAMPAIGN':
                state_view += '<div class=""campaign-contents"">' +
                        ...
                        '<div><a id=""detail-label"" onclick=""toggling(this)"" class=""control-label"">Mô tả chi tiết<");
            WriteLiteral(@"/a>' +
  ...
  ");
            WriteLiteral(@"                                      '<option selected value=""crm"">Bộ phận nghiệp vụ</option>' +
                        ...
                        '<div class=""trigger-area"">' +
                            ...
                            '<select class=""form-control"" id=""trigger-cons' + id + '"">' +
                                '<option selected selected value=""campaign"">campaign</option>' +
                                '<o");
            WriteLiteral(@"ption value=""other"">Khác</option>' +
                            '</select>' +
                            ...
                            '<div class=""condition-area"">' +   
                                ...
                                '<div class=""events"" style=""display: inline-block"">' +
                                    ...
                                    '<select class=""form-control"" id=""trigger-even' + id + '"" style=""display: inline-block"">' +
                                        ...
                                        '<option valu");
            WriteLiteral(@"e=""other"">Khác</option>' +
                                    '</select>' + 
                                    ...
                                    '</select>' + 
                                    '<input style=""display:inline-block"" type=""text"" c");
            WriteLiteral(@"lass=""form-control"" id=""trigger-thre' + id +'"">' + 
                                '</div>' +
                            '</div>' +
                        '</div>' +
                        '<hr/></div>';
            ...
            case 'CONTACT':
                state_view += '<div class=""contact-contents"">' +
                        ...
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
                        '<div style=""display:block""><label class=""control-label"">Họ & t");
            WriteLiteral(@"ên</label>' +
                        ...
                        '</div></div>' +
                        '<div class=""role-area""><span hidden>Đối tượng thực hiện (chọn 1 hoặc nhiều): </span>' +
                                    '<select hidden class=""form-control"" id=""r");
            WriteLiteral(@"ole-type' + id + '"" multiple>' +
                                        '<option selected selected value=""hr"">Bộ phận nhân sự</option>' +
            ...
            case 'ABSENT':
                if ($('#manual-proceed').is(':checked')) {
                    state_view += '<div class=""absent-contents"">' +
                            ...
                            '<a hidden onclick=""toggling()"" class=""control-l");
            WriteLiteral(@"abel"">Mô tả chi tiết</a>' +
                            ...
                            '<textarea class=""form-control"" placeholder=""Lý do"" rows=""3"" id=""activity-reason' + id + '"">Có việc gấp</");
            ...
            case 'EMAIL':
                state_view += '<div class=""email-container"">' + 
                    ...
                    '<div class=""email-body"">' +
                        '<label class=""control-label"" id=""email-content""></label><textarea class=""form-co");
            WriteLiteral(@"ntrol"" rows=""5"" id=""contents""></textarea>' +
                    '</div>' +
            ...
            case 'GENERIC':
                state_view += '<div class=""generic-contents"">' +
                        ...
                        '<div><a id=""detail-label"" oncl");
            WriteLiteral(@"ick=""toggling(this)"" class=""control-label"">Mô tả chi tiết</a>' +
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
    ...
    function add_transition(i) {
        ...
        '<select style=""display: inline-block"" class=""form-control"" id=""s");
            WriteLiteral(@"elect-cond' + i + '"">';
    ...
    $('#btn-submit').on('click', function (params) {
        ...
        for (let i = 1; i <= ids.length; i++) {
            ...
            if (tree) {
                ...
                node['description'] = activity['description'] = $('");
            WriteLiteral(@"#activity-desc' + i.toString()).val();
       ...
       ");
            WriteLiteral(@"         });
                ...
                activity['roles'] = [];
                activity['absentname'] = $('#activity-worker' + i.toString()).val();
                activity['dayoff'] = $('#activity");
            WriteLiteral(@"-off-day' + i.toString()).val();
                <!-- activity['isreallynotapproved'] = $('#activity-reason' + i.toString()).val(); -->
                <!-- activity['approvername'] = $('#activity-worker' + i.toString()).val(); -->
                activity['reason'] = $('#activity-reason' + i.toString()).val();
                roles.forEach(element => {
                ...
                if (!manual) {
                    activities");
            WriteLiteral(@".push(activity.name);
                    if(i == 1)
                    {
                ...
                request['process']['states'].p");
            WriteLiteral(@"ush(state);
            }
        ...
        if (!manual && !tree) {
            ...
            if (cdt > 1) {
                for (let i = 1; i < cdt; i++) {
                    ...
                    another_rule['currentstate'] = $('#select-cond' + i.t");
            WriteLiteral(@"oString()).val();                     
                    ...
                    if (!is_not_duplicated) {
                        request['process']['rules'].push(a");
            WriteLiteral(@"nother_rule);                 
                    }
                }
            }
        }
        if (tree) {
            ...
            request['process']['nodes'].forEach(node => {
                if (node.parent == null || node.parent == undefined || node.parent == '') {
                    ...
                    var par");
            WriteLiteral(@"ent = request['process']['nodes'][request['process']['nodes'].findIndex(i => i.name == node.parent)];
                    if (parent != null) {
