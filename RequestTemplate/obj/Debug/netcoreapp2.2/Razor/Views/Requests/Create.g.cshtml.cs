#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e00b4aff0c158028f561aa03ec471cb984d2a2fe"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e00b4aff0c158028f561aa03ec471cb984d2a2fe", @"/Views/Requests/Create.cshtml")]
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e00b4aff0c158028f561aa03ec471cb984d2a2fe5608", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e00b4aff0c158028f561aa03ec471cb984d2a2fe6006", async() => {
...
<script>
    ...
    function generate_path() {
      ...
      ");
            ...
            WriteLiteral(@" + 
                ...
                elem += '</select></div>';                
                if (!ac");
            WriteLiteral(@"tivities.includes(activity.name)) {
                    activities.push(activity.name);
                }
            }
            $('.progress-area').append(elem);
    ...
    function createstate(id, type) {  
        var state_view = '<div class=""state-header"">' +
            ...
            '<select hidden class=""form-control"" id=""state-type' + id + '"">' +
                '<option value=""normal"">Trung gian</opt");
            WriteLiteral(@"ion>' + 
        ...
        switch (type) {
            ...
            WriteLiteral(@"aceholder=""Tên công việc"" id=""activity-name' + id + '"" value=""Xin nghỉ phép"">' +
            ...
            WriteLiteral(@"el"">Lý do: </label>' + 
                    ...
                    alert(""Chuyển lo");
            WriteLiteral(@"ại quy trình sang \""Cần người thẩm định\"" để tạo loại yêu cầu \""Vắng mặt\"""");
                    return '';
                }
                break;
            case 'EMAIL':
    ...
    function add_transition(i) {
        ...
        elem += '</select>' +
        'thì đi đến' +
        '<select style=""display: inline-block"" class");
            WriteLiteral(@"=""form-control"" id=""select-answ' + i + '"">';
        activities.forEach(activity => {
            elem += '<option value=""' + activity + '"">' + activity +'</option>';
        });
            ...
            case 'ABSENT':
                if ($('#manual-proceed').is(':checked')) {
                    activity_view = '<div class=""absent-contents"">' +
                            ...
                            '<span hidden>Thời gian thực hiện công việc (giờ): </span> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"" hidden value=""1"">' +
                            '<input type=""text"" class=""form-control"" placeholder=""Tên nhân viên"" id=""activity-worker' + id + '"" value=""Nguyễn Văn A"">' +
                            '<span>Ngày vắng mặt: </span> <input type=""date"" type=""text"" class=""form-control"" placeholder=""Ngày vắng mặt"" id=""activity-off-day");
            WriteLiteral(@"' + id + '"">' +
                            '<textarea class=""form-control"" placeholder=""Lý do"" rows=""3"" id=""activity-reason' + id + '"">Có việc gấp</textarea>' +
                            '<span hidden id=""activity-type' + id + '"">ABSENT</span>' + 
                            '</div>' +
                    ...
                    alert(""Chuyển loại quy trình sang \""Cần người thẩm đị");
            WriteLiteral(@"nh\"" để tạo loại yêu cầu \""Vắng mặt\"""");
                    activity_view = '';
                }
                break;
            case 'EMAIL':
            ...
            case 'GENERIC':
                activity_view = '<div class=""generic-contents"">' +
                        ...
                        '<div class=""role-area"">' +
                                '<select class=""form-control"" id=""role-type' + id + '"" multiple>' +
                                    '<o");
            WriteLiteral(@"ption value=""hr"">Bộ phận nhân sự</option>' +
                                    '<option value=""cm"">Bộ phận nghiệp vụ</option>' +
                                    '<option value=""other"">Khác</option>' +
                                '</select>' +
                        '</div>' +
  ...
  ");
        ...
        if (!tree) {
            for (let i = 0; i < ids.length; i++) {
                ...
                {
              ");
            WriteLiteral(@"      rules.states['end'] = activity;
                }
            }
        }
        else {
 ...
 ");
            WriteLiteral(@"   $('#btn-submit').on('click', function (params) {
        var states = [];
    ...
    ");
        ...
        for (let i = 1; i <= ids.length; i++) {
            ...
            WriteLiteral(@"y' + i.toString()).val();
                ...
                state = {};
                state['name'] = activity['name'] = $('#activit");
            WriteLiteral(@"y-name' + i.toString()).val();
     ...
     ");
            WriteLiteral(@"               if(rules.states.start == state.name)
                    {
                        state['statetype'] = 'start';
                    }
        ...
        if (!manual && !tree) {
         ...
         ");
            WriteLiteral(@"       if (!actions.includes(path.action)) {
            ...
            if (cdt > 1) {
                for (let i = 1; i < cdt; i++) {
                    ...
                    for (let index = 0; index < request['process']['rules'].length; index++) {
                        ...
                        if (rule.action == another_rule.action || rule.currentstate == another_rule.currentstate || rule.nextstate == another_");
            WriteLiteral(@"rule.nextstate) {
        ...
        if (tree) {
          ...
          ");
            WriteLiteral(@"      if (node.parent == null || node.parent == undefined || node.parent == '') {
                    node.level = 0;
                }
                else {
        ...
        if (tree) {
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(31087, 36, false);
#line 666 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(31123, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(31667, 32, false);
#line 684 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(31699, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
