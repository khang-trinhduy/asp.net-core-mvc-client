#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4d0489c8c1ce35129b62bdf702ae40fc83822d36"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4d0489c8c1ce35129b62bdf702ae40fc83822d36", @"/Views/Requests/Create.cshtml")]
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4d0489c8c1ce35129b62bdf702ae40fc83822d365608", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4d0489c8c1ce35129b62bdf702ae40fc83822d366006", async() => {
...
<script>
            ...
            WriteLiteral(@"                  '</select>' +
                        ...
                        '<div class=""trigger-area"">' +
                            ...
                            '<div class=""condition-area"">' +
                                ...
                                '<div class=""events"">' +
    ");
            WriteLiteral(@"                                '<label class=""control-label"">On: </label>' +
                                    '<select class=""form-control"" id=""trigger-cons' + id + '"">' +
                                    ...
                                    '</select>' + 
                                    '<select class=""form-control"" id=""trigger-cons' + id + '"">' +
                                        '<option selected selected value=""greaterorequal"">>=</optio");
            WriteLiteral(@"n>' +
                                        '<option value=""lesserorequal""><=</option>' +
                                    '</select>' + 
                                    '<input type=""text"" class=""form-control"" id=""trigger-threshold' + id +'"">' + 
                                '</div>' +
                            '</div>' +
                        '</div>' +
                        '<hr/></div>';
            ...
            case 'CONTACT':
                state_view += '<div class=""contact-contents"">' +
                        ...
                        '<div><a id=""detail-label"" onclick=""toggling(this)"" class=""control-label"">Mô tả chi tiết</a>' +
                        '<input type=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this");
            WriteLiteral(@")"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
            ...
            case 'EMAIL':
                state_view += '<div class=""email-container"">' + 
                    '<div class=""email-header"">' +
                        ...
                        '<label class=""control-label"" id=""subject"">Subject: </label><input class=""form-control"" id=""subject"" type=""text"" place");
            WriteLiteral(@"holder="""" />' +
                        '</div>' +
            ...
            WriteLiteral(@"+= '<div class=""generic-contents"">' +
                        ...
                        '<div class=""role-area""><label class=""control-label"">Đối tượng thực hiện (chọn 1 hoặc nhiều):</label>' +
                                '<select class=""form-control"" id=""role-type' + id + '"" multiple>' +
                                    '<option value=""hr"">B");
            WriteLiteral(@"ộ phận nhân sự</option>' +
    ...
    functio");
            WriteLiteral(@"n add_transition(i) {
        var elem = '';
    ...
    ");
            WriteLiteral(@"function toggling(self) {
    ...
    function get_rule() {
        ...
        if (!tree) {
            ...
            for (let i = 1; i <= cc; i++) {
                ...
                var action = $('#node-action' + cur.toStrin");
            WriteLiteral(@"g()).val();
        ...
        for (let i = 1; i <= ids.length; i++) {
          ...
          ");
            WriteLiteral(@"      roles.forEach(element => {
                ...
                activity['activitytype'] = $('#activity-type' + i.toString()).text();
                var roles =$('#rol");
            WriteLiteral(@"e-type' + i.toString()).val();
                activity['roles'] = [];
                activity['absentname'] = $('#activity-worker' + i.toString()).val();
                activity['dayoff'] = $('#activity-off-day' + i.toString()).val();
                <!-- activity['isreallynotapproved'] = $('#activity-reason' + i.toString()).val(); -->
   ...
   ");
        ...
        if (tree) {
            ...
            request['process']['nodes'].forEach(nod");
            WriteLiteral(@"e => {
    ...
    ");
            ...
            EndContext();
            BeginContext(37434, 36, false);
#line 737 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(37470, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(38014, 32, false);
#line 755 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(38046, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
