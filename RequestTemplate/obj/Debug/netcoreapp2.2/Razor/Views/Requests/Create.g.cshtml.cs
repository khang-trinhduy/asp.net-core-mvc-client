#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "82b1d8000afb221d8d8238d79bedd36be2194248"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"82b1d8000afb221d8d8238d79bedd36be2194248", @"/Views/Requests/Create.cshtml")]
...
<div class=""state-area"">
    <div class=""add-state-area"">
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "82b1d8000afb221d8d8238d79bedd36be21942485608", async() => {
                BeginContext(1435, 14, true);
                WriteLiteral("\r\n            ");
                EndContext();
                BeginContext(1449, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "82b1d8000afb221d8d8238d79bedd36be21942486006", async() => {
...
<script>
    ...
    function add_path(i) {
        ...
        for (let j = 0; j < ids.length;j++) {
            const ai = ids[j];
            var name = $('#activity-name' + ai.toStri");
            WriteLiteral(@"ng()).val();
            elem += '<option value=""' + name + '"">' + name + '</option>';
        }
        elem += '</select><div style=""display: inline-block"" class=""path"">' + 
    ...
    function change(item, params) {
        for (let i = 0; i < ids.length; i++) {
            const cur = ids[i];
            if(cur != params) {
                $('#state-graph' + cur.toString() + ' op");
            WriteLiteral(@"tion').each(function () { 
    ...
    function createstate(id, type) {  
        var state_view = '<div class=""state-header"">' +
            ...
            '<select hidden class=""form-control"" id=""state-type' + id + '"">' +
                ...
                '<option ");
            WriteLiteral(@"value=""end"">Kết thúc</option>' + 
            '</select>' + 
        ...
        switch (type) {
            case 'CAMPAIGN':
                state_view += '<div class=""campaign-contents"">' +
                        ...
                        '<a class=""control-lab");
            WriteLiteral(@"el"" onclick=""toggling(this)"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
            ...
            case 'CONTACT':
                state_view += '<div class=""contact-contents"">' +
                        ...
                        '<input type=""text"" class=""form-control"" placeholder=""Họ & tê");
            WriteLiteral(@"n"" id=""activity-cont' + id + '"">' +
            ...
            WriteLiteral(@" value=""hr"">Bộ phận nhân sự</option>' +
                                        '<option selected value=""crm"">Bộ phận nghiệp vụ</option>' +
                                        '<option value=""other"">Khác</option>' +
                                    '</select>' +
                            '</div>' +
            ...
            WriteLiteral(@"aceholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '"">' +
      ...
      ");
            WriteLiteral(@"              '<div class=""email-header"">' +
                    ...
                    '</div>' +
                    '<");
            WriteLiteral(@"div class=""email-attachment"">' +
            ...
            case 'GENERIC':
                state_view += '<div class=""generic-contents"">' +
                        ...
                        '<div><a id=""detail-label"" onclick=""toggling(this)"" class=""control-label"">Mô tả chi tiết</a>' +
                        '<input ty");
            WriteLiteral(@"pe=""text"" class=""form-control"" placeholder=""Mô tả nội dung công việc"" id=""activity-desc' + id + '""></div>' +
                        '<a class=""control-label"" onclick=""toggling(this)"">Thời gian thực hiện công việc (giờ): </a> <input type=""number"" class=""form-control"" id=""activity-dura' + id + '"">' +
    ...
    function add_transition(i) {
        ...
        activities.forEach(activity => {
            elem += '<option valu");
            WriteLiteral(@"e=""' + activity + '"">' + activity +'</option>';
        });
        elem += '</select>' +
        ...
        if (!tree) {
            for (let i = 0; i < ids.length; i++) {
                ...
                if (i < ids.length - 1)
                {
                    ...
                    var next = cur + 1;
                    rule['nextstate'] = $('");
            WriteLiteral(@"#state-graph' + next.toString()).val();
                    rule['action'] = 'approve';
   ...
   ");
        ...
        for (let i = 1; i <= ids.length; i++) {
            ...
            if (tree) {
                ...
                activity['duration'] = $('#activity-dura' + ");
            WriteLiteral(@"i.toString()).val();
                ...
                if (activity.roles.length <= 0) {
                    alert('Chưa chọ");
            WriteLiteral(@"n đối tượng phụ trách công việc ' + activity.name);
                    return;
                }
                node['activities'] = [];
                ...
                activity['absentname'] = $('#activity-worker' + i.toString()).val();
                activity['dayoff'] = $('#activity-off-day' + i.toString()).val();
                <!-- activity['isreallynotapproved'] = $('#activit");
            WriteLiteral(@"y-reason' + i.toString()).val(); -->
                <!-- activity['approvername'] = $('#activity-worker' + i.toString()).val(); -->
                activity['reason'] = $('#activity-reason' + i.toString()).val();
                roles.forEach(element => {
                    if(!activity['roles'].some(e => e.name === element)) {
                ...
                if (!manual) {
                    ...
                    {
                      ");
            WriteLiteral(@"  state['statetype'] = 'start';
                    }
        ...
        if (!manual && !tree) {
            ");
            WriteLiteral(@"request['process']['actions'] = ['auto'];
            ...
            if (cdt > 1) {
                for (let i = 1; i < cdt; i++) {
                    ...
                    another_rule['nextstate'] = $('#select-a");
            WriteLiteral(@"nsw' + i.toString()).val();
                    if (activate_trigger) {
...
");
        ...
        if (tree) {
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(35078, 36, false);
#line 706 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("createtree", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(35114, 543, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
            ...
            $.ajax({
                ...
                url: '");
            EndContext();
            BeginContext(35658, 32, false);
#line 724 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\Create.cshtml"
                 Write(Url.Action("create", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(35690, 484, true);
            WriteLiteral(@"',
                data: request,
                dataType: ""json"",
                header: {
