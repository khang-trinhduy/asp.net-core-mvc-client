#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "914b64bca82d8d0de9a20641d67f8439418ce116"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"914b64bca82d8d0de9a20641d67f8439418ce116", @"/Views/Requests/progressing.cshtml")]
    ...
    function call_something(id,state,activity,action) {
        tasks.forEach(task => {
            ...
            WriteLiteral(@"""datatype"": ""TalentLeave"", ""absentname"": $('#activity-abse' + id.toString()).text(), ""approvername"": $('#activity-appr' + id.toString()).val(), ""dayoff"": $('#activity-dayo' + id.toString()).text(), ""reason"": $('#activity-reas' + id.toString()).text(), ""isdone"": true, ""isreallynotapproved"": isreallynotapproved};
                ...
                var url = '");
            EndContext();
            BeginContext(5711, 37, false);
#line 205 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml"
                      Write(Url.Action("dosomething", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(5748, 9055, true);
    ...
    function absent_template(activity, state) {
        ...
        '<div class=""absent-container"">' +");
            ...
            '<div class=""absent-contents"">' +
                ...
                '<input class=""form-");
            WriteLiteral(@"control"" type=""text"" id=""activity-data' + activity.id + '"" placeholder=""Message"" />' +
  ...
  ");
    ...
    function email_template(activity) {
        ...
        '<div class=""email-container"">' +
            '<div class=""email-header"">' +
                ...
                '<label class=""control-label"" id=""subject"">Subject: </label><input class=""form-control"" id=""subject' + activity.id +'"" type=""text"" placehold");
            WriteLiteral(@"er="""" />' +
            '</div>' +
        ...
        '<div class=""generic-container"">' +
          ...
          ");
            WriteLiteral(@"                  }
                ...
                elem += '<button class=""btn btn-default"" onclick=""complete_task(' + activity.id + ')"">' + btn + '</button>'
            '</div>' +
        '</div>';
        return elem;
    }
    ...
    $(function () {
        ...
        states.forEach(state => {
            ...
            '<div clas");
            WriteLiteral(@"s=""progress-state"" onclick=""slide(this)"">';
                ...
                '<div class=""activities"">';
                    state.activities.forEach(activity => {
                        switch (activity.activityType) {
                            case 3:
                                elem += generic(activity);
                                break;
                            case 0:
                                elem += email_template(activity);
                                break;
                            case 1:
                                elem += '<label class=""control-label"">' + activity.name ");
            WriteLiteral(@"+ '</label>';
                                break;
                            case 2:
