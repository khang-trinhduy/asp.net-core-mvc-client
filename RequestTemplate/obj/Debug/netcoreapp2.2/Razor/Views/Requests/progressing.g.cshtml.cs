#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "439df4e5bc5f8a15cb8fcd2f10512ab2ea8ee6c8"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"439df4e5bc5f8a15cb8fcd2f10512ab2ea8ee6c8", @"/Views/Requests/progressing.cshtml")]
    ...
    function call_something(id,state,activity,action) {
        tasks.forEach(task => {
            ...
            WriteLiteral(@"= {""datatype"": ""TalentLeave"", ""absentname"": $('#activity-abse' + id.toString()).text(), ""approvername"": $('#activity-appr' + id.toString()).val(), ""dayoff"": $('#activity-dayo' + id.toString()).text(), ""reason"": $('#activity-reas' + id.toString()).text(), ""isdone"": true, ""isreallynotapproved"": isreallynotapproved};
                ...
                var url = '");
            EndContext();
            BeginContext(6135, 37, false);
#line 214 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml"
                      Write(Url.Action("dosomething", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(6172, 2052, true);
 ...
 ");
            ...
            WriteLiteral(" = \'");
            EndContext();
            BeginContext(8225, 37, false);
#line 254 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml"
                      Write(Url.Action("dosomething", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(8262, 3669, true);
    ...
    function campaign_template(activity, state) {
        ...
        '<div class=""campaign-container"">' +
            '<div class=""campaign-contents"">' +
                ...
                '<select class=");
            WriteLiteral(@"""form-control"" id=""activity-camp' + activity.id + '"">' +
                '<option value=""c1"">Campaign 1</option>' +
                '<option value=""c2"">Campaign 2</option>' +
                '<option value=""c3"">Campaign 3</option>' +
                '</select>' +
                '<input type=""button"" value=""Start"" onclick=""start_campaign(' + activity.id + ')"" class=""btn btn-info"" />' +
            '</div>' +
        '</div>';
        return elem;
    }

    function start_campaign(params) {
        var campaign = $('#activity-camp' + param.toString()).val();
        var url = '");
            EndContext();
            BeginContext(11932, 39, false);
#line 317 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml"
              Write(Url.Action("StartCampaign", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(11971, 12853, true);
    ...
    function node_generic(activity, node, actions) {
        ...
        '<div class=""generic-container"">' +
            '<div class=""activity-header"">' +
                ...
                if (activity.description != null) {
                    elem += '<p id=""activity-desc' + activity.id + '"">Mô tả (hướng dẫn");
            WriteLiteral(@"): ' + activity.description + '</p>';
                }
                if (activity.duration > 0) {
                    elem += '<p id=""activity-desc' + activity.id + '"">Thời gian: ' + activity.duration + ' (giờ)</p>';
                }
            ...
            WriteLiteral(@"  if(data.dataType == 6)
                ...
                actions.forEach(action => {
                    elem += '<button class=""btn btn-success"" onclick=""node_call_something(' + activity.id +',\'' + node.trim() ");
            WriteLiteral(@"+ '\',\'' + activity.name.trim() + '\',\'' + action + '\')"">' + action + '</button>';
                });
                elem +=
            '</div>' +
        '</div>';
    ...
    $(function () {
        ...
        if (states.length > 0) {
          ...
          ");
            ...
            ");
            WriteLiteral(@"        actions.push(action.name);
                });
