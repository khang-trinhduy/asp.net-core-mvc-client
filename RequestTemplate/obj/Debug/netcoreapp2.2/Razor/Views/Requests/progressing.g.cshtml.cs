#pragma checksum "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e76d6e069792c543ef042a3c926db9a94f93d6d3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e76d6e069792c543ef042a3c926db9a94f93d6d3", @"/Views/Requests/progressing.cshtml")]
...
#line 141 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml"
                         Write(Html.Raw(Json.Serialize(Model.Process)));

#line default
#line hidden
            EndContext();
            BeginContext(3072, 109, true);
...
#line 166 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml"
                      Write(Url.Action("completetask", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(3925, 1974, true);
            WriteLiteral(@"';
    ...
    function call_something(id,state,activity,action) {
        tasks.forEach(task => {
            ...
            WriteLiteral(@"""datatype"": ""TalentLeave"", ""absentname"": $('#activity-abse' + id.toString()).text(), ""approvername"": $('#activity-appr' + id.toString()).val(), ""dayoff"": $('#activity-dayo' + id.toString()).text(), ""reason"": $('#activity-reas' + id.toString()).text(), ""isdone"": true, ""isreallynotapproved"": isreallynotapproved};
                ...
                var url = '");
            EndContext();
            BeginContext(5900, 37, false);
#line 209 "C:\Users\trinh\source\repos\RequestTemplate\RequestTemplate\Views\Requests\progressing.cshtml"
                      Write(Url.Action("dosomething", "requests"));

#line default
#line hidden
            EndContext();
            BeginContext(5937, 9865, true);
    ...
    function absent_template(activity, state) {
        ...
        '<div class=""absent-container"">' +");
            ...
            '<div class=""absent-contents"">' +
                ...
                '<input class=""form-c");
            WriteLiteral(@"ontrol"" type=""text"" id=""activity-data' + activity.id + '"" placeholder=""Message"" />' +
   ...
   ");
            WriteLiteral(@"             '<i class=""far fa-paper-plane"" title=""Gửi"" onclick=""addComment(' + id +')""></i>' +
            '</div>'+
        '</div>';
    }
    ...
    function email_template(activity) {
        ...
        '<div class=""email-container"">' +
            '<div class=""email-header"">' +
                ...
                '<label class=""control-label"" id=""subject"">Subject: </label><input class=""form-control"" id=""subject' + activity.id +'"" type=""text"" placeholde");
            WriteLiteral(@"r="""" />' +
            '</div>' +
    ...
    function generic(activity, state) {
        ...
        '<div class=""generic-container"">' +
            ...
            WriteLiteral(@"vity-data"">';
                ...
                elem += '<button class=""btn btn-success"" onclick=""call_something(' + activity.id +',\'' + sta");
            WriteLiteral(@"te.trim() + '\',\'' + activity.name.trim() + '\',\'approve\')"">Phê duyệt</button>' +
                ...
                '<div class=""activities"">';
                    state.activities.forEach(activity => {
                        switch (activity.activityType) {
                            ...
                            case 4:
           ");
            WriteLiteral(@"                     elem += absent_template(activity, state.name);
                                break;
